...
*** Work Planned [0/4]
**** TODO Rewrite the Energy plugin
- use Extendable
- better architecture
**** TODO Remove layers of indirections in the simgrid::Host and rearchitecture
- eg:
...
**** TODO Avoid simcall for getter when possible in simgrid::Host
Getters usually do not need to issue a simcall and could get the data directly.
**** TODO Remove code from simgrid::surf::Host?
- Remove simgrid::surd::Host?
- Do we need this to make the disctinction bewteen the user API and the internal SURF API?
* Abbreviations
