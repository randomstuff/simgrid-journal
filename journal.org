...
- Currently all thos remote access are implemented by reading in the
  ...
  in the MCed process).
*** Work Planed [/]
**** TODO Remote access to proces name
**** TODO Remote access to synchro
**** TODO Finish integration of thos modification in all the code
...
*** Work Planed [/]
**** TODO Remote access to host name
