...
- Working on MacOS X without DWARF:
  ...
  - In master, I should move all the libdwarf related code into a .c
    file (mc_libdwarf.c) and move all the libdwarf-independent code
    out of this file.  This would make this kinf od things easier.
*** Work plannes [0/1]
**** TODO SimGridMC on MacOS X without DWARF
* Abbreviations
